...
class ChampionDraftPredictor:
    ...
    def _initialize_champion_roles(self):
        ...
        return {
            ...
            'Gragas': 'Tank', 'Jarvan': 'Tank', 'JarvanIV': 'Tank', 'Leona': 'Tank',
            ...
            'Sion': 'Tank', 'Skarner': 'Tank', 'Tahm Kench': 'Tank', 'TahmKench': 'Tank',
            ...
            'MasterYi': 'Fighter', 'MonkeyKing': 'Fighter', 'Mordekaiser': 'Fighter',
            ...
            'Taliyah': 'Mage', 'Teemo': 'Mage', 'Twisted Fate': 'Mage', 'TwistedFate': 'Mage',
            'Veigar': 'Mage', 'Velkoz': 'Mage', 'Vex': 'Mage', 'Viktor': 'Mage',
            'Vladimir': 'Mage', 'Xerath': 'Mage', 'Ziggs': 'Mage',
            'Zilean': 'Mage', 'Zoe': 'Mage', 'Zyra': 'Mage',

            # ADC (Marksman)
            'Aphelios': 'ADC', 'Ashe': 'ADC', 'Caitlyn': 'ADC', 'Draven': 'ADC',
            'Ezreal': 'ADC', 'Jhin': 'ADC', 'Jinx': 'ADC', 'Kaisa': 'ADC',
            'Kalista': 'ADC', 'Kindred': 'ADC', 'Kogmaw': 'ADC', 'KogMaw': 'ADC',
            'Lucian': 'ADC', 'MissFortune': 'ADC', 'Quinn': 'ADC', 'Samira': 'ADC',
            'Sivir': 'ADC', 'Smolder': 'ADC', 'Tristana': 'ADC', 'Twitch': 'ADC',
            'Varus': 'ADC', 'Vayne': 'ADC', 'Xayah': 'ADC', 'Zeri': 'ADC',

            # Support
            'Bard': 'Support', 'Ivern': 'Support', 'Janna': 'Support', 'Lulu': 'Support',
            'Mel': 'Support', 'Milio': 'Support', 'Nami': 'Support',
            'Rakan': 'Support', 'Renata': 'Support', 'Senna': 'Support', 'Seraphine': 'Support',
            'Sona': 'Support', 'Soraka': 'Support', 'Yuumi': 'Support', 'Yunara': 'Support',
        }
